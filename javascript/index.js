...
function loadVideoGrid() {
  ...
  // Loop through video IDs and create iframe elements
  videoIDs.forEach((id) => {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Example: If you want to add event listeners for other interactions, do here
  // e.g., toggle menu, fetch other data, etc.
});
